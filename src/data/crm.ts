...
export const leads: Lead[] = Array.from({ length: 36 }, (_, i) => {
  ...
  return {
    ...
    history: [
      { at: `${pad(day)}-07-2026 04:15 PM`, by: agents[i % agents.length]!, action: `Status changed to ${st.status}` },
      { at: `${pad(day)}-07-2026 02:40 PM`, by: agents[i % agents.length]!, action: "Outgoing call — 2m 14s" },
...
export const projectList: Project[] = [
  { id: "P-01", name: "One Residency", city: "Pune", type: "Residential", dataCount: 4, matching: 18, available: true, price: "₹ 78L onwards", units: "2 & 3 BHK" },
  { id: "P-02", name: "Mandate Towers", city: "Mumbai", type: "Residential", dataCount: 0, matching: 6, available: true, price: "₹ 1.4Cr onwards", units: "3 BHK" },
  { id: "P-03", name: "Vari Properties LLP", city: "Pune", type: "Commercial", dataCount: 0, matching: 2, available: true, price: "₹ 92L onwards", units: "Office" },
  { id: "P-04", name: "Project Alpha", city: "Nashik", type: "Residential", dataCount: 0, matching: 9, available: false, price: "₹ 52L onwards", units: "1 & 2 BHK" },
  { id: "P-05", name: "Aamor", city: "Pune", type: "Residential", dataCount: 0, matching: 12, available: true, price: "₹ 66L onwards", units: "2 BHK" },
  { id: "P-06", name: "Synergy", city: "Thane", type: "Commercial", dataCount: 3, matching: 21, available: true, price: "₹ 1.1Cr onwards", units: "Retail" },
  { id: "P-07", name: "Aloha", city: "Pune", type: "Residential", dataCount: 1, matching: 15, available: true, price: "₹ 84L onwards", units: "3 BHK" },
  { id: "P-08", name: "Pavilion", city: "Nagpur", type: "Residential", dataCount: 0, matching: 4, available: false, price: "₹ 48L onwards", units: "1 BHK" },
  { id: "P-09", name: "Green Acres", city: "Pune", type: "Agricultural", dataCount: 0, matching: 1, available: true, price: "₹ 22L / acre", units: "Plots" },
  { id: "P-10", name: "Retail Hub", city: "Mumbai", type: "Commercial", dataCount: 2, matching: 7, available: true, price: "₹ 2.2Cr onwards", units: "Showroom" },
];
...
export const agentReports: AgentReport[] = [
  { user: "Archana Sarwade", workingHours: "07:42", calls: 5, uniqueCalls: 5, whatsapp: 2, email: 0, sms: 0, statusEdits: 11, formEdits: 3, notes: 18, active: true },
  { user: "Bhushan Supekar", workingHours: "08:15", calls: 20, uniqueCalls: 13, whatsapp: 6, email: 1, sms: 0, statusEdits: 13, formEdits: 6, notes: 20, active: true },
  { user: "Haina Parde", workingHours: "03:20", calls: 0, uniqueCalls: 0, whatsapp: 0, email: 0, sms: 0, statusEdits: 0, formEdits: 1, notes: 0, active: false },
  { user: "Harshada Jadhav", workingHours: "08:48", calls: 18, uniqueCalls: 13, whatsapp: 4, email: 2, sms: 1, statusEdits: 27, formEdits: 1, notes: 33, active: true },
  { user: "Ishvar Dhanegave", workingHours: "09:05", calls: 21, uniqueCalls: 19, whatsapp: 9, email: 0, sms: 0, statusEdits: 10, formEdits: 29, notes: 25, active: true },
  { user: "Jatin Thakkar", workingHours: "06:30", calls: 0, uniqueCalls: 0, whatsapp: 0, email: 0, sms: 0, statusEdits: 0, formEdits: 0, notes: 0, active: true },
  { user: "Komal Daund", workingHours: "07:10", calls: 3, uniqueCalls: 3, whatsapp: 1, email: 0, sms: 0, statusEdits: 8, formEdits: 2, notes: 14, active: true },
  { user: "Mohit Mankar", workingHours: "08:02", calls: 14, uniqueCalls: 13, whatsapp: 5, email: 0, sms: 0, statusEdits: 8, formEdits: 11, notes: 27, active: true },
  { user: "Mohit Tiwari", workingHours: "02:15", calls: 0, uniqueCalls: 0, whatsapp: 0, email: 0, sms: 0, statusEdits: 0, formEdits: 0, notes: 0, active: false },
  { user: "Rupali Vadvkar", workingHours: "08:36", calls: 26, uniqueCalls: 22, whatsapp: 11, email: 3, sms: 0, statusEdits: 19, formEdits: 8, notes: 41, active: true },
  { user: "Shital Shinde", workingHours: "07:55", calls: 12, uniqueCalls: 10, whatsapp: 3, email: 1, sms: 0, statusEdits: 14, formEdits: 4, notes: 22, active: true },
  { user: "Sneha Patil", workingHours: "05:44", calls: 7, uniqueCalls: 6, whatsapp: 2, email: 0, sms: 0, statusEdits: 5, formEdits: 2, notes: 9, active: false },
];
...
export const moduleSettings = [
  ...
  { title: "Projects and Properties", desc: "Customized property & project features", icon: "building" as const },
...
export const integrations = {
  "3rd Parties": ["99 Acres", "Estate Dekho", "Flipkart", "Housing", "Magic Bricks", "MyGate", "Property Wala", "Quikr Homes", "Real Estate India", "Roofandfloor", "Webhook", "Common Floor"],
  "Social Platforms": ["Gmail", "Google Ads Landing", "Google Ads Leads Form", "Google Campaign", "Microsoft Ads", "Whatsapp", "Facebook", "Instagram"],
